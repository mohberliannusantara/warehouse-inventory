...
class Kendaraan extends CI_Controller
{
    ...
    public function export()
    {
        ...
        $barang = $this->kendaraan_model->get_limit($this->session->userdata('id_rayon'), $this->session->userdata('id_level'));
        ...
        foreach ($barang as $data) { // Lakukan looping pada variabel siswa
            ...
            $excel->setActiveSheetIndex(0)->setCellValue('D' . $numrow, $data->plat);
            $excel->setActiveSheetIndex(0)->setCellValue('E' . $numrow, $data->nama_kondisi);
            $excel->setActiveSheetIndex(0)->setCellValue('F' . $numrow, $data->nama_jenis_barang);
