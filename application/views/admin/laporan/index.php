        ...
        <div class="card ">
          ...
          <div class="col-md-6">
            ...
            <div class="card-footer ">
              ...
              <button type="submit" class="btn btn-fill btn-warning"><i class="material-icons">arrow_downward</i>Donwload</a>
                <?php echo form_close()?>
            ...
            <div class="col-md-6">
              <div class="card ">
                ...
                <div class="card-footer ">
                  ...
                  <button type="submit" class="btn btn-fill btn-success"><i class="material-icons">arrow_downward</i>Donwload</a>
                    <?php echo form_close()?>
