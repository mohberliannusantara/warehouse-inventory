      ...
      <div class="col-md-3">
        <div class="card card-pricing card-raised">
          <div class="card-body">
            ...
            <a href="<?php echo base_url('admin/kendaraan/create') ?>" class="btn btn-rose btn-round">Tambah</a>
          </div>
        </div>
      </div>
      <div class="col-md-9">
                  ...
                  <?php foreach ($kendaraan as $value): ?>
                    <tr>
                      ...
                      <td class="text-center">
                        ...
                        <a href="<?php echo base_url('Kendaraa/edit/') . $value->id_kendaraan ?>" rel="tooltip" title="Ubah" class="btn btn-sm btn-warning">
                          <i class="material-icons">edit</i>
                        </a>
                        <a href="<?php echo base_url('Kendaraa/delete/') . $value->id_kendaraan ?>" rel="tooltip" title="Hapus" class="btn btn-sm btn-danger">
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="input-group no-border">
          <label class="bmd-label-floating">ID Kendaraa</label>
  ...
  <div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLongTitle">Info Kendaraa</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
