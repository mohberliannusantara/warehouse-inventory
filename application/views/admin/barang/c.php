  ...
  <div class="col-md-6 ml-auto mr-auto">
    <div class="card">
      <div class="card-header text-center">
        <h4 class="card-title">
          Tambah Data Extracomptable
        </h4>
        <h5 class="card-description">Tambahkan data extracomptable kedalam daftar</h5>
        <a href="<?php echo base_url('admin/barang/create') ?>" class="btn btn-info">
