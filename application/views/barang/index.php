                    ...
                    <?php foreach ($barang as $value): ?>
                      <tr>
                        ...
                        <td>
                          ...
                          <a href="#" data-toggle="modal" data-target="#confirmModal" rel="tooltip" title="Hapus" class="btn btn-sm btn-danger">
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="submit" href="<?php echo base_url('Barang/delete/') . $value->id_barang ?>" class="btn btn-danger">Hapus</button>
